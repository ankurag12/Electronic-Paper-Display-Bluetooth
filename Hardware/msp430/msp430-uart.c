...
#include "../../pl/gpio.h"
#include <stdint.h>
#include <file.h>			// Header file specific to Code Composer Studio
#include <stdio.h>
...
__interrupt void USCI_ISR(void)
{
  ...
  case 2:                                   // Vector 2 - RXIFG
	  globalKey=UCxnRXBUF;                  //  -> RXed character
    break;
...
{
	add_device("msp430UART", _MSA,				// add_device function defined in file.h (specific to CCS). stdout and stderr routed to serial port
