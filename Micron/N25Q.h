...
static uAddrType BlockOffset(uSectorType uscSectorNr);
...
static ReturnType FlashWriteNVConfigurationRegister(NMX_uint16 ucpNVConfigurationRegister);
static ReturnType FlashWriteVolatileConfigurationRegister(NMX_uint8 ucpVolatileConfigurationRegister);
