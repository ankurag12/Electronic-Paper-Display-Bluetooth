...
static void fill_addr_vect(uAddrType udAddr, NMX_uint8* pIns_Addr, NMX_uint8 num_address_byte);
static ReturnType WAIT_TILL_Instruction_EXECUTION_COMPLETE(NMX_sint16 second);
...
*******************************************************************************/
static ReturnType DataProgram(InstructionType insInstruction, ParameterType *fp)
{
	ReturnType rRetVal;
	NMX_uint8 insCode;
...
Pseudo Code:
   ...
   Step 3: Return the Error Code
*******************************************************************************/
static ReturnType DataRead(InstructionType insInstruction, ParameterType *fp)
{
	NMX_uint8 insCode;
	ReturnType rRetVal;
...
*******************************************************************************/
static ReturnType FlashWriteEnable( void )
{
...
Pseudo Code:
   ...
   Step 2: Send the packet serially
*******************************************************************************/
static ReturnType  FlashWriteDisable( void )
{
	CharStream char_stream_send;
...
*******************************************************************************/
static ReturnType FlashReadDeviceIdentification(NMX_uint32 *uwpDeviceIdentification)
{
	CharStream char_stream_send;
	CharStream char_stream_recv;
...
*******************************************************************************/
static ReturnType FlashReadStatusRegister(NMX_uint8 *ucpStatusRegister)
{
	CharStream char_stream_send;
	CharStream char_stream_recv;
...
*******************************************************************************/
static ReturnType  FlashWriteStatusRegister(NMX_uint8 ucStatusRegister)
{
	CharStream char_stream_send;
...
*******************************************************************************/
static ReturnType FlashDataRead( uAddrType udAddr, NMX_uint8 *ucpElements, NMX_uint32 udNrOfElementsToRead, NMX_uint8 insInstruction)
{
	CharStream char_stream_send;
	CharStream char_stream_recv;
...
*******************************************************************************/
static ReturnType FlashGenProgram(uAddrType udAddr, NMX_uint8 *pArray , NMX_uint32 udNrOfElementsInArray, NMX_uint8 ubSpiInstruction)
{
	CharStream char_stream_send;
	NMX_uint8 pIns_Addr[5];
	NMX_uint8 fsr_value;
...
*******************************************************************************/
static ReturnType  FlashSectorErase( uSectorType uscSectorNr )
{
	CharStream char_stream_send;
...
Pseudo Code:
   ...
   Step 6: Wait until the operation completes or a timeout occurs.
*******************************************************************************/
static ReturnType  FlashSubSectorErase( uSectorType uscSectorNr )
{
	CharStream char_stream_send;
	NMX_uint8  pIns_Addr[5];
...
*******************************************************************************/
static ReturnType  FlashDieErase( uSectorType uscDieNr )
{
	CharStream char_stream_send;
	NMX_uint8  pIns_Addr[5];
	uAddrType DieAddr;
...
*******************************************************************************/
#ifdef SUPPORT_N25Q_STEP_B
static ReturnType FlashBulkErase( void )
{
	CharStream char_stream_send;
...
*******************************************************************************/
static BOOL IsFlashWELBusy(void)
{
	NMX_uint8 ucSR;
...
*******************************************************************************/
static ReturnType FlashDataProgram(uAddrType udAddr, NMX_uint8 *pArray , NMX_uint16 udNrOfElementsInArray, NMX_uint8 ubSpiInstruction)
{
 ...
 ******************************************************************************/
static ReturnType  FlashProgramEraseResume( void )
{
	/* not implemented */
	return Flash_FunctionNotSupported;
}
 ...
 ******************************************************************************/
static ReturnType  FlashProgramEraseSuspend( void )
{
	/* not implemented */
	return Flash_FunctionNotSupported;
}
...
*******************************************************************************/
static ReturnType  FlashClearFlagStatusRegister( void )
{
	CharStream char_stream_send;
...
*******************************************************************************/
static ReturnType  FlashReadNVConfigurationRegister(NMX_uint16 *ucpNVConfigurationRegister)
{
	CharStream char_stream_send;
	CharStream char_stream_recv;
...
*******************************************************************************/
static ReturnType  FlashReadVolatileConfigurationRegister( NMX_uint8 *ucpVolatileConfigurationRegister)
{
	CharStream char_stream_send;
	CharStream char_stream_recv;
...
*******************************************************************************/
static ReturnType  FlashReadVolatileEnhancedConfigurationRegister( NMX_uint8 *ucpVolatileEnhancedConfigurationRegister)
{
	CharStream char_stream_send;
	CharStream char_stream_recv;
...
*******************************************************************************/
static ReturnType  FlashReadFlagStatusRegister( NMX_uint8 *ucpFlagStatusRegister)
{
	CharStream char_stream_send;
	CharStream char_stream_recv;
...
Pseudo Code:
   ...
   Step 4: Wait until the operation completes or a timeout occurs.
*******************************************************************************/
static ReturnType  FlashWriteVolatileConfigurationRegister( NMX_uint8 ucVolatileConfigurationRegister)
{
	CharStream char_stream_send;
	NMX_uint8  pIns_Val[2];
...
Pseudo Code:
   ...
   Step 5: Wait until the operation completes or a timeout occurs.
*******************************************************************************/
static ReturnType  FlashWriteVolatileEnhancedConfigurationRegister( NMX_uint8 ucVolatileEnhancedConfigurationRegister)
{
	CharStream char_stream_send;
	NMX_uint8  pIns_Val[2];
...
Pseudo Code:
   ...
   Step 4: Wait until the operation completes or a timeout occurs.
*******************************************************************************/
static ReturnType  FlashWriteNVConfigurationRegister( NMX_uint16 ucNVConfigurationRegister)
{
	CharStream char_stream_send;
...
*******************************************************************************/
static NMX_sint8 *FlashErrorStr( ReturnType rErrNum )
{
	switch(rErrNum)
	{
...
-----------------------------------------------------------------------------*/
static ReturnType FlashTimeOut(NMX_uint32 udSeconds)
{
...
Pseudo Code:
   ...
   Step 4: Wait until the operation completes or a timeout occurs.
*******************************************************************************/
static ReturnType FlashEnter4ByteAddressMode(void)
{
	CharStream char_stream_send;
...
Pseudo Code:
   ...
   Step 4: Wait until the operation completes or a timeout occurs.
*******************************************************************************/
static ReturnType FlashExit4ByteAddressMode(void)
{
	CharStream char_stream_send;
...
*******************************************************************************/
static ReturnType FlashLockSector(uAddrType address,  NMX_uint32 len)
{
	NMX_uint8 TB, BP, SR;
...
*******************************************************************************/
static ReturnType FlashUnlockAllSector(void)
{
	NMX_uint8 SR = 0;
...
*******************************************************************************/
static ReturnType FlashOTPProgram(NMX_uint8 *pArray , NMX_uint32 udNrOfElementsInArray)
{
	CharStream char_stream_send;
	NMX_uint8 i;
	NMX_uint8 pIns_Addr[5];
...
*******************************************************************************/
static ReturnType FlashOTPRead(NMX_uint8 *ucpElements, NMX_uint32 udNrOfElementsToRead)
{
	CharStream char_stream_send;
	CharStream char_stream_recv;
	NMX_uint8  pIns_Addr[5];
