...
#define JD_FORMAT		2	/* Output pixel format 0:RGB888 (3 BYTE/pix), 1:RGB565 (1 WORD/pix), 2:GREY (1 BYTE/pix) */
#define	JD_USE_SCALE	1	/* Use descaling feature for output */
#define JD_TBLCLIP		1	/* Use table for saturation (might be a bit faster but increases 1K bytes of code size) */

/* R,G,B weights for converting to greyscale. Only applicable if JD_FORMAT = 2 (greyscale) */
